...
# 🟥 PUT
#
# Telegram에서는 일반 텍스트 색상 변경이 불가능하므로
# 이모지 블록으로 CALL / PUT을 시각적으로 구분한다.
# ============================================================
...
# ============================================================
# ⭐ CALL / PUT ONE-LINE BAR STRUCTURE
# ============================================================
